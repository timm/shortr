...
> ***SOME(`max` :?int) :SOME*** :bangbang:  Constructor of a collector for, at most, `max` numbers.
...
> ***has(`i` :SOME):tab*** :bangbang:  Ensure contents are sorted. Return those contents.
