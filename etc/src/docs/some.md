...
> ***SOME(`max` :?int) :SOME*** :arrow_right:  Constructor of a collector for, at most, `max` numbers.
...
> ***has(`i` :SOME):tab*** :arrow_right:  Ensure contents are sorted. Return those contents.
