...
> ***SOME(`max` :?int) :SOME***. &nbsp;  &nbsp;  &nbsp;   &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; :information_source:    Constructor of a collector for, at most, `max` numbers.
...
> ***add(`i` :`SOME` : `x` :num)***. &nbsp;  &nbsp;  &nbsp;   &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; :information_source:    
...
> ***has(`i` :SOME):tab***. &nbsp;  &nbsp;  &nbsp;   &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; :information_source:    Ensure contents are sorted. Return those contents.
