...
> ***SOME(`max` :?int) :SOME***. &nbsp;  &nbsp;  &nbsp;   &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; :triangular_flag_on_post:     Constructor of a collector for, at most, `max` numbers.
...
> ***add(`i` :`SOME` : `x` :num)***. &nbsp;  &nbsp;  &nbsp;   &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; :triangular_flag_on_post:     
...
> ***has(`i` :SOME):tab***. &nbsp;  &nbsp;  &nbsp;   &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; :triangular_flag_on_post:     Ensure contents are sorted. Return those contents.
