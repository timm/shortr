...
> ***SYM(`at` :?int, `txt` :?str) :SYM***. &nbsp;  &nbsp;  &nbsp;   &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; :information_source:    Summarize a stream of non-numerics.
...
> ***add(`i` :`SYM` : `x` :any, `n` :?int=1)***. &nbsp;  &nbsp;  &nbsp;   &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; :information_source:    Add `n` count to `i.kept[n]` .
...
> ***bin(`i` :`SYM` : `x` :any)***. &nbsp;  &nbsp;  &nbsp;   &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; :information_source:    return `x` mapped to a finite range (just return x)
...
> ***clone(`i` :SYM) :SYM***. &nbsp;  &nbsp;  &nbsp;   &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; :information_source:    Return a class of the same structure.
...
> ***like(`i` :SYN,`x` :any,`prior` :num):num***. &nbsp;  &nbsp;  &nbsp;   &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; :information_source:    return how much `x` might belong to `i`.
...
> ***merge(`i` :SYM,`j` :SYM):SYM***. &nbsp;  &nbsp;  &nbsp;   &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; :information_source:    combine two symbols
...
> ***merge(`i` :SYM,`t` :tab):tab***. &nbsp;  &nbsp;  &nbsp;   &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; :information_source:    merge a list of bins (for symbolic y-values)
...
> ***mid(`i` :SYM):tab***. &nbsp;  &nbsp;  &nbsp;   &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; :information_source:    Return a columns' `mid`ddle (central tendency).
...
> ***div(`i` :SYM):tab***. &nbsp;  &nbsp;  &nbsp;   &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; :information_source:    Return `div`ersity of a column
